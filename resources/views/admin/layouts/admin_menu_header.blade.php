				...
				<div class="horizontal-mainwrapper container clearfix">
					...
					<nav class="horizontalMenu clearfix">
						...
						<ul class="horizontalMenu-list">
    						...
    						@canany(['admin.countries.index','admin.cities.index' ,'admin.states.index','admin.times.index','admin.holidays.index'])
								...
								<ul class="sub-menu">
								  ...
								  @endcan 
								   ...
								   @can('admin.countries.index')
									...
									<li aria-haspopup="true"><a href="{{ route('admin.states.index') }}" class="slide-item">States</a></li>
