...
<div class="container">
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                {!! Form::open(['method' => 'POST','files'=>true,'route' => ['admin.customers.store'],'class' => 'form-horizontal','id' => 'frmUser']) !!}
                ...
                <div class="card-body">
                    ...
                    <div class="form-group {{$errors->has('address2') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="address2" value="{{old('address2')}}"  class="form-control @error('address2') is-invalid @enderror" id="address2" placeholder="address 1" >
                    ...
                    <div class="form-group {{$errors->has('state_id') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                        ...
                        <div class="col-md-6">
                           {!! Form::select('state_id', $state, old('state_id'), ['id'=>'state_id', 'class' => 'form-control select2', 'placeholder' => '-Select State-']) !!}
                    ...
                    <div class="form-group {{$errors->has('city_id') ? config('constants.ERROR_FORM_GROUP_CLASS') : ''}}">
                        ...
                        <div class="col-md-6">
                           {!! Form::select('city_id', [], old('city_id'), ['id'=>'city_id', 'class' => 'form-control select2', 'placeholder' => '-Select City-']) !!}
