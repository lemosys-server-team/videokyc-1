...
Route::group(['middleware' => ['frontend']], function(){	
	Route::group(['middleware' => ['domain_check']], function(){	
		Route::get('/{url?}', 'HomeController@index')->name('home');//->where(['url' => '|home'])
	});
	Route::get('user/verify/{id}', 'HomeController@verify')->name('verify');
	Route::post('user/verifyOTP', 'HomeController@verifyOTP')->name('verifyOTP');
});
...
Route::group(['middleware' => ['auth']], function(){
	Route::get('access-denied', function(){
		...
		Route::get('schedules/thankyou/{id}', 'SchedulesController@thankyou')->name('schedules.thankyou');
